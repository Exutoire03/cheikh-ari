...
const Footer = () => {
  ...
  return (
    ...
    <footer className="bg-white dark:bg-black border-t border-gray-200 dark:border-gray-800/50 transition-colors duration-300">
      <div className="max-w-7xl mx-auto pt-16 pb-8 px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
          ...
          <div className="md:col-span-5 space-y-6">
            ...
            <div>
              <h3 className="text-sm font-semibold text-slate-700 dark:text-slate-300 uppercase tracking-wider mb-3">Discutons de votre projet</h3>
              <a 
                href="mailto:cheikhdev.web@gmail.com" 
                className="inline-flex items-center gap-2 text-sky-500 dark:text-sky-400 hover:text-sky-600 dark:hover:text-sky-300 font-medium transition-colors"
              >
                <FiMail />
          ...
          <div className="md:col-span-7 grid grid-cols-2 sm:grid-cols-3 gap-8">
            <div>
              <h3 className="text-sm font-semibold text-slate-900 dark:text-slate-100 uppercase tracking-wider mb-4">Navigation</h3>
            ...
            <div>
              <h3 className="text-sm font-semibold text-slate-900 dark:text-slate-100 uppercase tracking-wider mb-4">Réseaux</h3>
              <ul className="space-y-3">
                {socialLinks.map((item) => (
                  <li key={item.name}>
                    <a
                      ...
                      className="inline-flex items-center gap-3 text-slate-600 dark:text-slate-400 hover:text-sky-500 dark:hover:text-sky-400 transition-colors duration-300"
                    >
                      {item.icon}
                      <span>{item.name}</span>
                    </a>
